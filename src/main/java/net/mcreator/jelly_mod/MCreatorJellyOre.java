...
public class MCreatorJellyOre extends Elementsjelly_mod.ModElement {
	@ObjectHolder("jelly_mod:jellyore")
	public static final Block block = null;

	public MCreatorJellyOre(Elementsjelly_mod instance) {
		super(instance, 7);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(MCreatorJelly.block, (int) (3)));
		}
	}
			...
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, Biome.createDecoratedFeature(new OreFeature(OreFeatureConfig::deserialize) {
				...
				public boolean place(IWorld world, ChunkGenerator generator, Random rand, BlockPos pos, OreFeatureConfig config) {
					...
					if (dimensionType == DimensionType.THE_NETHER)
						dimensionCriteria = true;
					if (dimensionType == MCreatorTheJellyDemension.type)
						dimensionCriteria = true;
